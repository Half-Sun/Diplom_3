...
class OrderPageLocators:
    ...
    ORDER_FEED_TEXT = By.CSS_SELECTOR, 'h1.text.text_type_main-large.mt-10.mb-5'
    ...
    ORDER_MADE_CLOSE_BUTTON = By.CSS_SELECTOR, "button.Modal_modal__close_modified__3V5XS"
